...
/**
 * Living Archive Dropdown Menu
 *
 * Premium dropdown design with golden accents and cinematic animations
 *
 * Features:
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    className={cn(
      ...
      "border border-border/30 bg-popover/95 backdrop-blur-xl",
      "text-popover-foreground shadow-elevation-4",
      // Animations
