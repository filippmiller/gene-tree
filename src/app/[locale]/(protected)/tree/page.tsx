    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center space-x-8">
              ...
              <div className="hidden md:flex space-x-4">
                ...
                <Link href={`/${locale}/tree`} className="px-3 py-2 rounded-md text-sm font-medium bg-purple-50 text-purple-700">
                  Tree View
                </Link>
                <Link href={`/${locale}/profile/settings`} className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100">
                  Settings
                </Link>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          ...
          <p className="text-gray-600">Визуализация подтверждённых связей</p>
        </div>
