  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center p-4 bg-[#0a0a0c] overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Ambient glow orbs */}
        <div className="absolute top-1/3 -right-32 w-[500px] h-[500px] bg-[#D29922]/8 rounded-full blur-[150px] animate-pulse" style={{ animationDuration: '5s' }} />
        <div className="absolute -bottom-20 left-1/4 w-[400px] h-[400px] bg-[#D29922]/6 rounded-full blur-[120px] animate-pulse" style={{ animationDuration: '7s' }} />

        {/* Radial glow center */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#D29922]/5 rounded-full blur-[180px]" />
      ...
      <div className="relative z-10 w-full max-w-lg text-center space-y-8 animate-fade-in-up">
        ...
        <div className="relative mx-auto w-24 h-24">
          ...
          <div className="relative w-full h-full bg-card/80 backdrop-blur-md border border-white/[0.08] rounded-3xl flex items-center justify-center">
            <KeyRound className="w-10 h-10 text-[#D29922]/80" />
          </div>
          {/* Subtle glow ring */}
          <div className="absolute -inset-1 rounded-[26px] bg-[#D29922]/10 opacity-50" />
        </div>
        ...
        <div className="space-y-3 pt-4">
          ...
          <Button
            ...
            variant="outline"
            className="w-full h-14 bg-white/5 border-white/10 hover:bg-white/10 hover:border-[#D29922]/30 text-white font-medium text-base rounded-xl backdrop-blur-sm transition-all duration-300 group"
          >
            {t.goToSignIn}
